...
public class TextBox
{
    ...
    public Rect ShowGUI(SerializedObject serializedObject, int index)
    {
        ...
        var remove =
            GUI.skin.button.CalcSize(EditorGUIUtility.IconContent("d_TreeEditor.Trash", "Delete this TextBox"));
        ...
        if (GUI.Button(removeTextBoxButtonRect,
            EditorGUIUtility.IconContent("d_TreeEditor.Trash", "Delete this TextBox")))
        {
            if (!isBranched)
            {
        ...
        if (hasChoices)
        {
            ...
            for (var i = 0; i < choiceOptions.Count; i++)
            {
                ...
                if (GUI.Button(removeChoiceButton,
                    EditorGUIUtility.IconContent("d_TreeEditor.Trash", "Delete this TextBox")))
                {
